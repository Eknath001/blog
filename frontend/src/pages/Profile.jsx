...
//        try {
//            setLoading(true)
//            const res = await axios.put(`https://blog-1-dem7.onrender.com/api/v1/user/profile/update`, formData, {
//                headers: {
...
const Profile = () => {
    ...
    const user = {
        ...
        occupation: (rawUser?.occupation && rawUser.occupation !== "undefined") ? rawUser.occupation : "",
        bio: rawUser?.bio || "I'm a passionate web developer and content creator focused on frontend technologies. When I'm not coding, you can find me writing about tech, hiking, or experimenting with new recipes.",
