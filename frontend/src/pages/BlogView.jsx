...
//            const res = await axios.get(`https://blog-1-dem7.onrender.com/api/v1/blog/${selectedBlog?._id}/${action}`, { withCredentials: true })
//            if (res.data.success) {
...
//                            </div>
//                        </div>
//                        <div className="text-sm text-muted-foreground">Published on {changeTimeFormat(selectedBlog.createdAt)} • 1 min read</div>
//                    </div>
//                </div>
//
//                {/* Featured Image */}
...
const BlogView = () => {
  ...
  if (!selectedBlog) return <div className="text-center py-10">Loading blog...</div>
    ...
    <div className='pt-14'>
      <div className='max-w-6xl mx-auto p-10'>
        ...
        <div className="my-8">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="text-sm text-muted-foreground">
              Published {formatPublishedTime(selectedBlog.createdAt)} • 1 min read
            </div>
          </div>
        </div>
        ...
        <div className='mt-10'>
          ...
          <div className="flex items-center justify-between border-y border-gray-300 dark:border-gray-800 py-4 mb-8">
            <div className="flex items-center space-x-4">
              <Button onClick={likeOrDislikeHandler} variant="ghost" size="sm" className="flex items-center gap-1">
                {liked
                  ? <FaHeart size={24} className="text-red-600" />
                  : <FaRegHeart size={24} className="text-white hover:text-gray-600" />}
                <span>{blogLike}</span>
              </Button>
              <Button variant="ghost" size="sm" className="flex items-center gap-1">
                <MessageSquare className="h-4 w-4" />
